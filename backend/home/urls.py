...
urlpatterns = [
    ...
    path("person/<str:pk>/update-contact/", views.updatePersonContact, name="updatePersonContact"),
    path("person/<str:pk>/send-telegram/", views.sendPersonToTelegram, name="sendPersonToTelegram"),
    path("send-all-telegram/", views.sendAllToTelegram, name="sendAllToTelegram"),
